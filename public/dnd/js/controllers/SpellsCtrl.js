'use strict';
/* Controllers */
angular.module('dnd5e.controllers.spells', []).controller('spellsCtrl', ['$scope', '$sce', '$routeParams', 'spells',
    function($scope, $sce, $routeParams, spells) {
        $scope.spells = spells;
        ...
        $scope.matchesRitual = function(spell) {
        	console.log(spell.name, $scope.ritual);
